...
void Cmd_WhereAmI_f(const idCmdArgs& args)
{
	...
	gameLocal.Printf("I am at: (%f,%f,%f)\n",player->firstPersonViewOrigin.x, player->firstPersonViewOrigin.y, player->firstPersonViewOrigin.z);
}
...
// RITUAL END
	cmdSystem->AddCommand("whereami", Cmd_WhereAmI_f, CMD_FL_GAME, "print where player is in console");
